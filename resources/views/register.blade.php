		...
		<div class="container">
			<div class="header-grid">
				<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul>
<<<<<<< HEAD:resources/views/register.blade.php
						...
						<li class="active"><i class="glyphicon glyphicon-book" aria-hidden="true"></i><a href="register.blade.php">Register</a></li>
=======
...
>>>>>>> a9b723cef6cab613ec98df0a6f3f4311f7ad7eff:resources/views/register.blade.php
					</ul>
				</div>
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form class="animated wow slideInUp" data-wow-delay=".5s" action="register" method="post" autocomplete="on">
					...
					<input type="password" name="customer_cpassword" placeholder="Password Confirmation" required=" " >
					...
					<input type="text" name="customer_contact" placeholder="Address" required=" " >
